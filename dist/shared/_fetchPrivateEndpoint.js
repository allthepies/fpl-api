...
exports._fetchPrivateEndpoint = void 0;
...
function _fetchPrivateEndpoint(fetchCookie, session, endpoint, init) {
    return __awaiter(this, void 0, void 0, function () {
        var fetchWithCookies, response, errorBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    errorBody = _a.sent();
                    console.error("Error body: ".concat(errorBody));
...
exports._fetchPrivateEndpoint = _fetchPrivateEndpoint;
//# sourceMappingURL=_fetchPrivateEndpoint.js.map